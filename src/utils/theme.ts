...
const lightTheme: Theme = {
  autoAccept: 'rgb(124,58,237)', // Deep violet (less harsh than pure electric)
  bashBorder: 'rgb(219,39,119)', // Rose (pairs with orange brand)
  claude: 'rgb(217,119,87)', // Claude orange
  claudeShimmer: 'rgb(237,155,125)', // Lighter claude orange for shimmer effect
  claudeBlue_FOR_SYSTEM_SPINNER: 'rgb(79,99,230)', // Refined blue for system spinner
  claudeBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(115,135,245)', // Lighter blue for system spinner shimmer
  permission: 'rgb(79,99,230)', // Primary accent blue
  permissionShimmer: 'rgb(125,145,245)', // Lighter blue for shimmer effect
  planMode: 'rgb(13,116,116)', // Muted teal
  ide: 'rgb(59,118,188)', // Muted blue
  promptBorder: 'rgb(148,152,160)', // Neutral slate border
  promptBorderShimmer: 'rgb(178,182,190)', // Lighter gray for shimmer effect
  text: 'rgb(24,26,32)', // Soft black (easier on eyes)
  inverseText: 'rgb(255,255,255)', // White
  inactive: 'rgb(110,114,124)', // Secondary gray
  inactiveShimmer: 'rgb(150,154,164)', // Lighter gray for shimmer effect
  subtle: 'rgb(156,160,170)', // Tertiary text
  suggestion: 'rgb(79,99,230)', // Primary accent blue
  remember: 'rgb(67,56,202)', // Indigo remember link
  background: 'rgb(6,148,148)', // Teal accent (slightly restrained)
  ...
  // TUI V2 colors
  clawd_body: 'rgb(217,119,87)',
  clawd_background: 'rgb(0,0,0)',
  userMessageBackground: 'rgb(236, 238, 242)', // Cool off-white panel
  userMessageBackgroundHover: 'rgb(246, 247, 250)', // ≥246 to quantize distinct from base at 256-color level
  messageActionsBackground: 'rgb(226, 232, 242)', // cool gray — clearer separation from user bubble
  selectionBg: 'rgb(176, 208, 252)', // soft selection blue; dark fgs stay readable
  bashMessageBackgroundColor: 'rgb(248, 244, 248)',

  memoryBackgroundColor: 'rgb(228, 240, 246)',
  rate_limit_fill: 'rgb(79,99,230)', // Match accent
  rate_limit_empty: 'rgb(45,55,120)', // Dark blue
  fastMode: 'rgb(234,88,12)', // Electric orange
  fastModeShimmer: 'rgb(255,150,60)', // Lighter orange for shimmer
  // Brief/assistant mode
  briefLabelYou: 'rgb(37,99,235)', // Blue
  briefLabelClaude: 'rgb(217,119,87)', // Brand orange
...
const darkTheme: Theme = {
  autoAccept: 'rgb(175,145,255)', // Softer electric violet
  bashBorder: 'rgb(232,108,168)', // Rose (less neon than bright pink)
  claude: 'rgb(230,125,92)', // Warm Claude orange
  claudeShimmer: 'rgb(240,165,132)', // Lighter claude orange for shimmer effect
  claudeBlue_FOR_SYSTEM_SPINNER: 'rgb(142,162,255)', // Indigo-blue for system spinner
  claudeBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(172,188,255)', // Lighter blue for system spinner shimmer
  permission: 'rgb(168,182,255)', // Indigo-periwinkle accent
  permissionShimmer: 'rgb(198,208,255)', // Lighter indigo for shimmer
  planMode: 'rgb(78,158,148)', // Muted sage green
  ide: 'rgb(88,145,210)', // Slightly brighter muted blue
  promptBorder: 'rgb(118,122,136)', // Slate border — clearer frame
  promptBorderShimmer: 'rgb(148,152,166)', // Lighter slate for shimmer
  text: 'rgb(255,255,255)', // White
  inverseText: 'rgb(0,0,0)', // Black
  inactive: 'rgb(148,152,162)', // Softer secondary text
  inactiveShimmer: 'rgb(182,186,196)', // Lighter gray for shimmer effect
  subtle: 'rgb(100,104,118)', // Cool tertiary (readable on dark)
  suggestion: 'rgb(168,182,255)', // Match permission accent
  remember: 'rgb(168,182,255)', // Match permission accent
  background: 'rgb(38,168,160)', // Muted teal (replaces harsh bright cyan strip)
  success: 'rgb(86,196,118)', // Bright green
  error: 'rgb(252,115,132)', // Bright red
  warning: 'rgb(250,200,65)', // Amber
  merged: 'rgb(175,145,255)', // Electric violet (matches autoAccept)
  warningShimmer: 'rgb(255,224,90)', // Lighter amber for shimmer
  ...
  chromeYellow: 'rgb(251,188,4)', // Chrome yellow
  // TUI V2 colors
  clawd_body: 'rgb(230,125,92)',
  clawd_background: 'rgb(0,0,0)',
  userMessageBackground: 'rgb(45, 46, 52)', // Cool slate — calmer panel
  userMessageBackgroundHover: 'rgb(58, 60, 68)',
  messageActionsBackground: 'rgb(42, 48, 60)', // Slightly deeper slate blue
  selectionBg: 'rgb(42, 88, 132)', // Softer selection blue; light fgs stay readable
  bashMessageBackgroundColor: 'rgb(58, 54, 60)',

  memoryBackgroundColor: 'rgb(48, 58, 64)',
  rate_limit_fill: 'rgb(168,182,255)', // Match accent
  rate_limit_empty: 'rgb(72,78,108)', // Deeper indigo slate
  fastMode: 'rgb(255,128,40)', // Electric orange for dark bg
  fastModeShimmer: 'rgb(255,172,88)', // Lighter orange for shimmer
  briefLabelYou: 'rgb(130,185,240)', // Light blue
  briefLabelClaude: 'rgb(230,125,92)', // Brand orange
  rainbow_red: 'rgb(235,95,87)',
  rainbow_orange: 'rgb(245,139,87)',
  rainbow_yellow: 'rgb(250,195,95)',
  rainbow_green: 'rgb(145,200,130)',
