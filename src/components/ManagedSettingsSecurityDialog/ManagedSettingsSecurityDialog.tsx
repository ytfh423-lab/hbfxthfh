...
export function ManagedSettingsSecurityDialog(t0) {
  ...
  if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
    t9 = <Text>你的组织已配置了托管设置，可能允许执行任意代码或拦截你的提示和响应。</Text>;
    $[4] = t9;
  } else {
    t9 = $[4];
  }
  ...
  if ($[10] === Symbol.for("react.memo_cache_sentinel")) {
    t14 = <Text>仅在你信任组织的 IT 管理并预期这些设置被配置时才接受。</Text>;
    $[10] = t14;
  } else {
    t14 = $[10];
  }
  ...
  if ($[14] !== exitState.keyName || $[15] !== exitState.pending) {
    t17 = <Text dimColor={true}>{exitState.pending ? <>再次按 {exitState.keyName} 退出</> : <>回车确认 · Esc 退出</>}</Text>;
