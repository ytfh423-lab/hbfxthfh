...
export function ThinkingToggle(t0) {
  ...
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    t1 = [{
      ...
      value: "false",
      label: "已禁用",
      description: "Claude 将不使用扩展思考来回复"
    }];
    $[0] = t1;
  } else {
    t1 = $[0];
  ...
  if ($[14] === Symbol.for("react.memo_cache_sentinel")) {
    t8 = <Box marginBottom={1} flexDirection="column"><Text color="remember" bold={true}>切换思考模式</Text><Text dimColor={true}>启用或禁用此会话的思考功能。</Text></Box>;
    $[14] = t8;
  } else {
    t8 = $[14];
  }
