...
export function BypassPermissionsModeDialog(t0) {
  ...
  if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
    t3 = <Box flexDirection="column" gap={1}><Text>在绕过权限模式下，Claude Code 将不会在运行潜在危险命令之前征求你的批准。<Newline />此模式仅应在受限的沙箱容器/虚拟机中使用，该环境应限制互联网访问并可轻松恢复。</Text><Text>继续操作即表示你接受在绕过权限模式下运行时所有操作的责任。</Text><Link url="https://code.claude.com/docs/en/security" /></Box>;
    $[3] = t3;
  } else {
    t3 = $[3];
  }
