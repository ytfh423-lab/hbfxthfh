...
export function TrustDialog(t0) {
  ...
  if ($[20] === Symbol.for("react.memo_cache_sentinel")) {
    ...
    t17 = <Text>快速安全检查：这是你创建的或信任的项目吗？（例如你自己的代码、知名开源项目或团队的工作）。如果不是，请先花点时间检查此文件夹中的内容。</Text>;
    t18 = <Text>Claude Code 将能够读取、编辑和执行此处的文件。</Text>;
    $[20] = t16;
    $[21] = t17;
    $[22] = t18;
  } else {
  ...
  if ($[27] !== exitState.keyName || $[28] !== exitState.pending) {
    t22 = <Text dimColor={true}>{exitState.pending ? <>再次按 {exitState.keyName} 退出</> : <>回车确认 · Esc 取消</>}</Text>;
