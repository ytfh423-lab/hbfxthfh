...
export function Onboarding({
  ...
  const themeStep = <Box marginX={1}>
      <ThemePicker onThemeSelect={handleThemeSelection} showIntroText={true} helpText="之后可以通过 /theme 更改" hideEscToCancel={true} skipExitHandling={true} // Skip exit handling as Onboarding already handles it
    />
    </Box>;
...
为了最佳编码体验，请启用推荐的
            ...
            label: '不，稍后通过 /terminal-setup 设置',
            value: 'no'
          }]} onChange={value => {
            if (value === 'install') {
