...
export function ExitPlanModePermissionRequest({
  ...
  return <Box flexDirection="column" tabIndex={0} autoFocus onKeyDown={handleKeyDown}>
      <PermissionDialog color="planMode" title="准备好开始编码了吗？" innerPaddingX={0} workerBadge={workerBadge}>
...
export function buildPlanApprovalOptions({
  ...
  if (showUltraplan) {
    options.push({
      label: '否，使用 Ultraplan 在网页版 Claude Code 上优化',
      value: 'ultraplan'
    });
  }
  options.push({
