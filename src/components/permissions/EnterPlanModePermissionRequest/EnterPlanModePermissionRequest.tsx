...
export function EnterPlanModePermissionRequest(t0) {
  ...
  if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
    t2 = <Text>Claude 想进入计划模式以探索和设计实现方案。</Text>;
    $[5] = t2;
  } else {
    t2 = $[5];
  }
  ...
  if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
    t3 = <Box marginTop={1} flexDirection="column"><Text dimColor={true}>在计划模式下，Claude 将：</Text><Text dimColor={true}> · 全面探索代码库</Text><Text dimColor={true}> · 识别现有模式</Text><Text dimColor={true}> · 设计实现策略</Text><Text dimColor={true}> · 提交计划供你审批</Text></Box>;
    $[6] = t3;
  } else {
    t3 = $[6];
  }
